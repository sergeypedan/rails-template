...
# policy.report_to    "https://code2travelcom.report-uri.com/r/d/csp/enforce" # Specify URI for violation reports

	policy.base_uri     csp.base_uri_values.join(separator)
